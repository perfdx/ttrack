...
export const CONFIG = {
  ...
  roster: [
    ...
    { name: 'Katja Mangold',      flags: ['DE'],        number: '45A', color: '#f6a5c0', photo: 'assets/riders/katja.png',  focus: 'center 30%', strava: 'https://strava.app.link/GAC2tv4073b', instagram: 'https://www.instagram.com/balance4life.de' },
