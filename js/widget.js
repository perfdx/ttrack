...
function socialLinks(r) {
  ...
  // Website-Icon nur, wenn eine URL hinterlegt ist (kein Platzhalter).
  const website = r.website ? item('soc-web', r.website, 'Website', web) : '';
  return `<div class="rc-social">${item('soc-strava', r.strava, 'Strava', strava)}${item('soc-ig', r.instagram, 'Instagram', insta)}${website}</div>`;
}
